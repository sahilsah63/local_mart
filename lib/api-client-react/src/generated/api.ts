 ...
 */
export const updateMyLocation = async (locationInput: LocationInput, options?: RequestInit): Promise<User> => {
 ...
 */
export const listShops = async (params?: ListShopsParams, options?: RequestInit): Promise<ShopListResponse> => {
 ...
 * @summary Delete shop
 */
export const deleteShop = async (id: number, options?: RequestInit): Promise<MessageResponse> => {
 ...
 */
export const verifyShop = async (id: number, options?: RequestInit): Promise<Shop> => {
...
export const getVerifyShopMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof verifyShop>>, TError,{id: number}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof verifyShop>>, TError,{id: number}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof verifyShop>>, {id: number}> = (props) => {
          const {id} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type VerifyShopMutationResult = NonNullable<Awaited<ReturnType<typeof verifyShop>>>
 ...
 * @summary Verify/unverify shop (admin)
 */
export const useVerifyShop = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof verifyShop>>, TError,{id: number}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
 ...
 */
export const listTechnicians = async (params?: ListTechniciansParams, options?: RequestInit): Promise<TechnicianListResponse> => {
 ...
 */
export const deleteTechnician = async (id: number, options?: RequestInit): Promise<MessageResponse> => {
...
export const updateTechnicianLocation = async (id: number,
    locationInput: LocationInput, options?: RequestInit): Promise<Technician> => {
...
export const getUpdateTechnicianLocationMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateTechnicianLocation>>, TError,{id: number;data: BodyType<LocationInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof updateTechnicianLocation>>, TError,{id: number;data: BodyType<LocationInput>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof updateTechnicianLocation>>, {id: number;data: BodyType<LocationInput>}> = (props) => {
          const {id,data} = props ?? {};
 ...
 * @summary Update technician live location
 */
export const useUpdateTechnicianLocation = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateTechnicianLocation>>, TError,{id: number;data: BodyType<LocationInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
 ...
 */
export const updateTechnicianAvailability = async (id: number,
    availabilityInput: AvailabilityInput, options?: RequestInit): Promise<Technician> => {
...
export const getUpdateTechnicianAvailabilityMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateTechnicianAvailability>>, TError,{id: number;data: BodyType<AvailabilityInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof updateTechnicianAvailability>>, TError,{id: number;data: BodyType<AvailabilityInput>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof updateTechnicianAvailability>>, {id: number;data: BodyType<AvailabilityInput>}> = (props) => {
          const {id,data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type UpdateTechnicianAvailabilityMutationBody = BodyType<AvailabilityInput>
 ...
 */
export const verifyTechnician = async (id: number, options?: RequestInit): Promise<Technician> => {
...
export const getVerifyTechnicianMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof verifyTechnician>>, TError,{id: number}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof verifyTechnician>>, TError,{id: number}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof verifyTechnician>>, {id: number}> = (props) => {
          const {id} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type VerifyTechnicianMutationResult = NonNullable<Awaited<ReturnType<typeof verifyTechnician>>>
 ...
 * @summary Verify/unverify technician (admin)
 */
export const useVerifyTechnician = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof verifyTechnician>>, TError,{id: number}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
 ...
 */
export const updateBookingLocation = async (id: number,
    locationInput: LocationInput, options?: RequestInit): Promise<Booking> => {
...
export const getUpdateBookingLocationMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateBookingLocation>>, TError,{id: number;data: BodyType<LocationInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof updateBookingLocation>>, TError,{id: number;data: BodyType<LocationInput>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof updateBookingLocation>>, {id: number;data: BodyType<LocationInput>}> = (props) => {
          const {id,data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type UpdateBookingLocationMutationResult = NonNullable<Awaited<ReturnType<typeof updateBookingLocation>>>
 ...
 * @summary Update technician live location for active booking
 */
export const useUpdateBookingLocation = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateBookingLocation>>, TError,{id: number;data: BodyType<LocationInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
 ...
 */
export const listAllBookings = async (params?: ListAllBookingsParams, options?: RequestInit): Promise<BookingListResponse> => {
...
export const getGetBookingLocationsUrl = (bookingId: number,) => {




  return `/api/location/booking/${bookingId}`
}

/**
 * @summary Get live locations of both parties in a booking
 */
export const getBookingLocations = async (bookingId: number, options?: RequestInit): Promise<BookingLocations> => {

  return customFetch<BookingLocations>(getGetBookingLocationsUrl(bookingId),
  {
    ...options,
    method: 'GET'
...
export const getGetBookingLocationsQueryKey = (bookingId: number,) => {
    return [
    `/api/location/booking/${bookingId}`
    ] as const;
    }


export const getGetBookingLocationsQueryOptions = <TData = Awaited<ReturnType<typeof getBookingLocations>>, TError = ErrorType<void>>(bookingId: number, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getBookingLocations>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetBookingLocationsQueryKey(bookingId);



    const queryFn: QueryFunction<Awaited<ReturnType<typeof getBookingLocations>>> = ({ signal }) => getBookingLocations(bookingId, { signal, ...requestOptions });





   return  { queryKey, queryFn, enabled: bookingId !== null && bookingId !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getBookingLocations>>, TError, TData> & { queryKey: QueryKey }
}

export type GetBookingLocationsQueryResult = NonNullable<Awaited<ReturnType<typeof getBookingLocations>>>
export type GetBookingLocationsQueryError = ErrorType<void>
...
export function useGetBookingLocations<TData = Awaited<ReturnType<typeof getBookingLocations>>, TError = ErrorType<void>>(
 bookingId: number, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getBookingLocations>>, TError, TData>, request?: SecondParameter<typeof customFetch>}

 ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } {

  const queryOptions = getGetBookingLocationsQueryOptions(bookingId,options)
...
export const getGetNearbyShopsUrl = (params: GetNearbyShopsParams,) => {
  ...
  return stringifiedParams.length > 0 ? `/api/location/nearby-shops?${stringifiedParams}` : `/api/location/nearby-shops`
}

/**
 * @summary Get nearby shops within radius
 */
export const getNearbyShops = async (params: GetNearbyShopsParams, options?: RequestInit): Promise<ShopWithDistance[]> => {
...
export const getGetNearbyShopsQueryKey = (params?: GetNearbyShopsParams,) => {
    return [
    `/api/location/nearby-shops`, ...(params ? [params] : [])
    ] as const;
    }


export const getGetNearbyShopsQueryOptions = <TData = Awaited<ReturnType<typeof getNearbyShops>>, TError = ErrorType<unknown>>(params: GetNearbyShopsParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getNearbyShops>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetNearbyShopsQueryKey(params);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getNearbyShops>>> = ({ signal }) => getNearbyShops(params, { signal, ...requestOptions });
...
export function useGetNearbyShops<TData = Awaited<ReturnType<typeof getNearbyShops>>, TError = ErrorType<unknown>>(
 params: GetNearbyShopsParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getNearbyShops>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
...
export const getGetNearbyTechniciansUrl = (params: GetNearbyTechniciansParams,) => {
  const normalizedParams = new URLSearchParams();
  ...
  return stringifiedParams.length > 0 ? `/api/location/nearby-technicians?${stringifiedParams}` : `/api/location/nearby-technicians`
}

/**
 * @summary Get nearby technicians within radius
 */
export const getNearbyTechnicians = async (params: GetNearbyTechniciansParams, options?: RequestInit): Promise<TechnicianWithDistance[]> => {

  return customFetch<TechnicianWithDistance[]>(getGetNearbyTechniciansUrl(params),
  {
    ...options,
    method: 'GET'
...
export const getGetNearbyTechniciansQueryKey = (params?: GetNearbyTechniciansParams,) => {
    return [
    `/api/location/nearby-technicians`, ...(params ? [params] : [])
    ] as const;
    }


export const getGetNearbyTechniciansQueryOptions = <TData = Awaited<ReturnType<typeof getNearbyTechnicians>>, TError = ErrorType<unknown>>(params: GetNearbyTechniciansParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getNearbyTechnicians>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetNearbyTechniciansQueryKey(params);



    const queryFn: QueryFunction<Awaited<ReturnType<typeof getNearbyTechnicians>>> = ({ signal }) => getNearbyTechnicians(params, { signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getNearbyTechnicians>>, TError, TData> & { queryKey: QueryKey }
}

export type GetNearbyTechniciansQueryResult = NonNullable<Awaited<ReturnType<typeof getNearbyTechnicians>>>
...
export function useGetNearbyTechnicians<TData = Awaited<ReturnType<typeof getNearbyTechnicians>>, TError = ErrorType<unknown>>(
 params: GetNearbyTechniciansParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getNearbyTechnicians>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
