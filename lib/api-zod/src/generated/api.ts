...
export const GetRevenueStatsResponse = zod.object({
  ...
  "topTechnicians": zod.array(zod.object({
  "id": zod.number(),
  "name": zod.string(),
  "bookings": zod.number(),
  "revenue": zod.number(),
 ...
 */
export const GetBookingLocationsParams = zod.object({
  "bookingId": zod.coerce.number()
})

export const GetBookingLocationsResponse = zod.object({
...
export const GetNearbyTechniciansResponse = zod.array(GetNearbyTechniciansResponseItem)
